...
PADDLE_PAGE_MARGIN_PT = _env_int("PADDLE_PAGE_MARGIN_PT", 36, minimum=0)
PADDLE_BOTTOM_PADDING_PERCENT = _env_int("PADDLE_BOTTOM_PADDING_PERCENT", 0, minimum=0)  # no longer used by paddle padding (now uniform 36pt)
...
MINERU_LANGUAGE = os.getenv("MINERU_LANGUAGE", "chinese_cht")
